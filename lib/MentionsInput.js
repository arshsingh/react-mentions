...
var MentionsInput = (_temp = _class = function (_React$Component) {
  ...
  this.updateSuggestionsPosition = function () {
    ...
    if (_this3.props.suggestionsPortalHost) {
      ...
      // guard for mentions suggestions list clipped by right edge of window
      if (_this3.containerRef && _left + suggestions.offsetWidth > _this3.containerRef.offsetWidth) {
        position.right = 0;
      } else {
        position.left = _left;
      }
      ...
      var tooltipBottom = _this3.containerRef ? _this3.containerRef.getBoundingClientRect().top + caretPosition.top + suggestions.offsetHeight : 0;
